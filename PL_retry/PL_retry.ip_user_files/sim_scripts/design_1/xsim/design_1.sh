...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L xil_defaultlib -L xlconstant_v1_1_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
