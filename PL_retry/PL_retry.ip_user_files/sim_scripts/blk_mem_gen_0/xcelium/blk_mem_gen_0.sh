...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"X:/xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"X:/xilinx/Vivado/2024.1/data/xilinx_vip/include" \
