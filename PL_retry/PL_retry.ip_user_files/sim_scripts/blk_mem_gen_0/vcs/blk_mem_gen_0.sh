...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"X:/xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"X:/xilinx/Vivado/2024.1/data/xilinx_vip/include" \
